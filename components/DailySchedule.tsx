                                        ...
                                        <div className="flex items-center justify-between gap-1.5">
                                            ...
                                            <div className="flex flex-col gap-1 min-w-0 flex-1">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {s.is_makeup && (
                                                        <span className="px-1.5 py-0.5 bg-amber-100 text-amber-600 text-[12px] font-extrabold rounded-md shrink-0">
                                                            보 {s.origin_date ? s.origin_date.substring(5).replace('-', '.') + '.' : ''}
                                                        </span>
                                                    )}
                                                </div>
                                                {/* 2줄: 담당 + 교사이름 + 과목 */}
                                            ...
                                            {userRole === 'admin' || userRole === 'owner' ? (
                                                ...
                                                <div className="flex gap-1 shrink-0 ml-auto">
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex flex-col items-center justify-center h-12 px-3 rounded-lg bg-blue-50 text-blue-600 border border-blue-200 transition-all active:scale-95 hover:bg-blue-100"
                                                    >
                                                        <CalendarIcon size={20} strokeWidth={2.5} />
                                                        <span className="text-[12px] font-semibold mt-0.5">일정변경요청</span>
                                                    </button>
                                                </div>
                                            )}
                                        </div>
